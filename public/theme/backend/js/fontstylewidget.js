...
!function (a) {
    ...
    a.cxColor = function () {
        var b, c, d, h, i, e = {dom: {}, api: {}}, f = function (a) {
        ...
        if (!(b.length < 1)) return e.init = function () {
            var e = this;
            e.dom.el = b, e.settings = a.extend({}, a.cxColor.defaults, c), e.dom.el.val().length > 0 && (e.settings.color = e.dom.el.val()), e.build(), e.api = {
                show: function () {
                    e.show()
                }, hide: function () {
                    e.hide()
                }, color: function () {
                    return e.setColor.apply(e, arguments)
                }, reset: function () {
                    e.reset()
                }, clear: function () {
                    e.clear()
            ...
            var f, g, h, i, b = this, c = ["00", "33", "66", "99", "cc", "ff"],
                d = ["ff0000", "00ff00", "0000ff", "ffff00", "00ffff", "ff00ff"], e = "";
            for (e = '<div class="panel_hd"><a class="reset" href="javascript://" rel="reset">默认颜色</a><a class="clear" href="javascript://" rel="clear">清除</a></div>', b.dom.colorPane = a("<div></div>", {"class": "cxcolor"}).appendTo("body").html(e), e = "", f = 0; 2 > f; f++) for (g = 0; 6 > g; g++) for (e += "<tr>", e += '<td title="#000000" style="background-color:#000000">', e += 0 == f ? '<td title="#' + c[g] + c[g] + c[g] + '" style="background-color:#' + c[g] + c[g] + c[g] + '">' : '<td title="#' + d[g] + '" style="background-color:#' + d[g] + '">', e += '<td title="#000000" style="background-color:#000000">', h = 0; 3 > h; h++) for (i = 0; 6 > i; i++) e += '<td title="#' + c[h + 3 * f] + c[i] + c[g] + '" style="background-color:#' + c[h + 3 * f] + c[i] + c[g] + '">';
            b.dom.colorTable = a("<table></table>").html(e).appendTo(b.dom.colorPane), b.dom.lockBackground = a("<div></div>", {"class": "cxcolor_lock"}).appendTo("body"), b.dom.colorPane.delegate("a", "click", function () {
                if (this.rel) switch (this.rel) {
                    case"reset":
                        return b.reset(), !1;
                    case"clear":
                        return b.clear(), !1
                }
            }), b.dom.colorTable.on("click", "td", function () {
                b.change(this.title)
            }), b.dom.el.on("click", function () {
                b.show()
            }), b.dom.lockBackground.on("click", function () {
                b.hide()
            }), b.change(b.settings.color)
        }, e.show = function () {
            var a = this, b = document.body.clientWidth, c = document.body.clientHeight,
                d = a.dom.colorPane.outerWidth(), e = a.dom.colorPane.outerHeight(), f = a.dom.el.offset().top,
                g = a.dom.el.offset().left, h = a.dom.el.outerWidth(), i = a.dom.el.outerHeight();
            f = f + e + i > c ? f - e : f + i, g = g + d > b ? g - (d - h) : g, a.dom.colorPane.css({
                top: f,
                left: g
            }).show(), a.dom.lockBackground.css({width: b, height: c}).show()
        }, e.hide = function () {
            this.dom.colorPane.hide(), this.dom.lockBackground.hide()
        }, e.change = function (a) {
            this.colorNow = a, this.dom.el.val(a).css("backgroundColor", a), this.dom.el.trigger("change"), this.hide()
        }, e.setColor = function (a) {
            return a ? (this.change(a), void 0) : this.colorNow
        }, e.reset = function () {
            this.change(this.settings.color)
        }, e.clear = function () {
            this.change("")
        }, e.init(), this
    }, a.cxColor.defaults = {color: "#000000"}, a.fn.cxColor = function (b, c) {
